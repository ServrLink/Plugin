...
try {
 ...
 // Synchronously check if a Discord ID is registered in the Registry  registered = api.isRegistered(discordId); // Checks whether a Discord ID is registered in the Registry
  success = registered.success; // Returns true if the request to the Registry was made successfully
  isRegistered = registered.isRegistered; // Returns true if the Discord ID was found in the registry

 // Asynchronously check if a Minecraft UUID is registered in the Registry  api.isRegistered(minecraftUuid, new Callback<Registered>() {
        @Override
 ...
 // Synchronously get a Minecraft UUID by Discord ID  RetrievedUUID retrievedUUID = api.getUUID(discordId);
 ...
 // Asynchronously get a Discord ID by Minecraft UUID  api.getDiscordID(minecraftUuid, new Callback<RetrievedID>() {
        @Override
